        ...
        <div className="max-w-xl w-full">
          ...
          <div className="space-y-8 text-[13px] md:text-[14px] text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p>
                Работа начинается с анализа ситуации — это базовая консультация без обязательств. На этом этапе
            ...
            <div>
              ...
              <p>
                Вход в работу составляет 500–1000$ (в зависимости от масштаба задачи) и входит в итоговую стоимость.
              </p>
              <p className="mt-3">
