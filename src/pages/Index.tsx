              ...
              >
                      ...
                      <motion.span
                        ...
                        variants={{
                          ...
                          visible: {
                            opacity: 1,
                            y: 0,
                            transition: { delay: 2.37, duration: 1.8, ease: [0.25, 0.1, 0.25, 1] },
                          },
                        }}
                      >
                        garden
                ...
                <motion.div
                  ...
                  variants={{
                    ...
                    visible: {
                      opacity: 1,
                      transition: { delay: 2.37, duration: 1.6, ease: [0.25, 0.1, 0.25, 1] },
                    },
                  }}
                >
                  {/* Mobile header */}
                  ...
                  <div className="text-left text-foreground">
                    ...
                    <motion.p
                      ...
                      variants={{
                        ...
                        visible: {
                          opacity: 1,
                          transition: { delay: 2.67, duration: 1.6, ease: "linear" },
                        },
                      }}
                    >
                      {t.index.tagline}
