    ...
    >
      ...
      <div className="flex flex-col items-start px-6 max-w-lg">
        ...
        <button
          ...
          className="group relative flex items-center bg-primary/20 border border-primary/40 rounded-full w-[90px] h-9 hover:bg-primary/30 transition-colors cursor-pointer"
        >
          <span
          ...
          />
          <span className={`text-xs font-semibold text-foreground tracking-wider transition-all duration-300 ease-in-out ${toggled ? 'ml-4' : 'ml-11'}`}>.uno</span>
        </button>
      </div>
