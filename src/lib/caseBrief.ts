...
type Labels = {
  ...
  attachments: string; urlUnavailable: string;
  attachmentsUseNote: string;
  optionalHypothesisTitle: string;
  optionalHypothesisIntro: string;
  expertTaskTitle: string;
  expertTaskBody: string;
