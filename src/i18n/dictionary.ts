...
export const dictionary: Record<Locale, Dictionary> = {
  ...
  uk: {
    ...
    clarity: {
      ...
      process_label: "Процес",
      process_steps: [
        { n: "01", title: "Заявка", body: "Ви описуєте ситуацію через спрямовану форму. Дзвінок не потрібен." },
      ...
      outcome_label: "Результат",
      outcome_body:
        "Точне письмове читання ситуації. Структура зроблена видимою, реальна задача названа, наступне осмислене рішення стає видимим.",
      format_label: "Формат",
      format_body:
      ...
      intake: {
        ...
        uncertain_intro: "Що залишається невирішеним, перевантаженим, важко піддається визначенню або блокує рух?",
