...
export const dictionary: Record<Locale, Dictionary> = {
  en: {
    ...
    semantic: {
      ...
      row_value: "value",
      row_pattern: "pattern",
      row_dominant: "dominant",
      row_dynamics: "dynamics",
      row_direction: "direction",
      row_tension: "tension",
      row_interaction: "interaction",
  ...
  ru: {
    ...
    semantic: {
      ...
      row_value: "значение",
      row_pattern: "паттерн",
      row_dominant: "доминанта",
      row_dynamics: "динамика",
      row_direction: "направление",
      row_tension: "напряжение",
      row_interaction: "взаимодействие",
      ...
      principles: {
        "0": "потенциал / семантический разрыв",
        "1": "импульс / начало",
        "2": "связь / взаимодействие",
        "3": "проявление / выражение",
        "4": "структура / стабилизация",
        "5": "изменение / движение",
        "6": "гармонизация",
        "7": "вопрос / глубина",
        "8": "материализация / плотность",
        "9": "завершение / переход",
      },
      principles_short: {
        "0": "разрыв",
        "1": "импульс",
  ...
  uk: {
    ...
    semantic: {
      ...
      row_value: "значення",
      row_pattern: "патерн",
      row_dominant: "домінанта",
      row_dynamics: "динаміка",
      row_direction: "напрям",
      row_tension: "напруга",
      row_interaction: "взаємодія",
      ...
      principles: {
        "0": "потенціал / семантичний розрив",
        "1": "імпульс / початок",
        "2": "зв'язок / взаємодія",
        "3": "прояв / вираження",
        ...
        "6": "гармонізація",
        "7": "питання / глибина",
        "8": "матеріалізація / щільність",
        "9": "завершення / перехід",
      },
      principles_short: {
        "0": "розрив",
        "1": "імпульс",
